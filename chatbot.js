...
function generateResponse(input) {
  ...
  const responses = [
    ...
    "Hello, Harsh how may i help you ?",
    ...
    // we return string accourding to the question.............
  if (!a.localeCompare("hello")) {
    return responses[0];
  } else if (!a.localeCompare("Hello")) {
    return responses[0];
  } else if (!a.localeCompare("My name is Harsh")) {
    return responses[1];
  } else if (!a.localeCompare("my name is harsh")) {
    return responses[1];
  } else {
